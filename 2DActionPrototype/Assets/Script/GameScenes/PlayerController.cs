...
public class PlayerController : MonoBehaviour
{
   ...
   　Rigidbody2D rigid2D; //コンポーネント「Rigidbody2D」を収納する
    ...
    float DashLimit = 20.0f;　//ダッシュ時の最高速度
    ...
    void Update()
    {
        ...
        {
            Debug.Log("NowPos" + transform.position.x);
            ...
            //if (this.player.transform.position.x >= 8.58f && JumpKeyDown == false)
            {
                ...
                //Debug.Log("JumpPoint:"+transform.position.x);
